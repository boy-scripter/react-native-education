  ...
  return (
    <View className="flex-1 bg-theme-900 ">
      ...
      <View style={{borderTopRightRadius: 20, borderTopLeftRadius: 20}} className="bg-white rounded-t-2xl flex-1 p-5">
        ...
        <Button label="Continue with Google" className="w-full border-greyish bg-white " textClassName="text-sm text-theme-900">
          <Image className="w-4 h-4" source={require('@assets/images/google.png')} />
        </Button>
      </View>
    </View>
  );
