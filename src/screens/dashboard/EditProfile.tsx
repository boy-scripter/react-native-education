  ...
  return (
    <TopImageLayout title="Edit Your Profile" description="Update your personal information below" lottie={require('@assets/lottie/profile.json')}>
      <ScrollView className="" contentContainerStyle={{flexGrow: 1}}>
        ...
        <ImageInput className='mx-auto ' value={user?.avatar!}></ImageInput>
          ...
          <RadioInput
            ...
            options={[
              ...
              {label: 'Other', value: 'other', icon: 'gender-binary'},
            ]}
          />

          <DatePickerInput label='Date Of Birth' value={birthday} onChange={setBirthday}></DatePickerInput>
